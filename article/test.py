...
class ArticleTestCase(TestCase):
    # testing a test database to check that our code is working
    def setUp(self): # note spelling important setUp.
    ...
    def test_hello_world_slug(self):
        obj = Article.objects.all().order_by('id').first() # getting the first index of a list, .last() is also possible
        title = obj.title
        slug = obj.slug
